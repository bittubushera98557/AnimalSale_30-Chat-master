...
//            var sourceFile = File("" + getRealPathFromURI(getImageUri(this@AddImages, takenBmp!!)));
...
subCat:desi
petName:tommy
petTitle:Black white Dog
petBreed:German
petAge:2.5
petPrice:1200
petDescription:this is my favourite dog , i have three dogs as same as it so i want to sale one
dollar:yes
action:
petID:*/
                ...
                .enqueue(object : Callback<AllApiResponse.CommonRes> {
                 ...
                 //       utilities.snackBar(tv_mobile, "" + response.body()!!.message)
                        ...
                        if (response.isSuccessful && (response.body()!!.status.equals("200"))) {
                            ...
                            intentMain.putExtra("message", /*"3"*/ "" + response.body()!!.message + "\n\n Your Pet has been uploaded sucessfully"/*+response.body()!!.data[0].id*/)
